      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full construction-glass mb-4">
            ...
            <span className="text-sm font-medium text-primary">BIM Talent Network</span>
          </div>
          <h1 className="text-4xl font-bold text-foreground mb-4 tech-heading high-contrast">
            {t('findTalent')}
          </h1>
          <p className="text-lg text-muted-foreground">
            Connect with skilled BIM professionals driving Thailand's digital construction revolution
          </p>
        </div>
